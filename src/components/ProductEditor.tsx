...
export function ProductEditor({ product, imageUrl, onSave, onClose, saveLabel = 'Save draft' }: { product: Product | null; imageUrl?: string; onSave: (input: ProductInput, image: Blob | null, onProgress: (value: number) => void) => Promise<void>; onClose: () => void; saveLabel?: string }) {
