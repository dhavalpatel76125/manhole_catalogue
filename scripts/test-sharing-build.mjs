...
assert.ok(html.includes('property="og:image" content="https://catalogue.fibro.test/fibro-catalogue-share-v2.jpg"'))
assert.ok(html.includes('rel="canonical" href="https://catalogue.fibro.test/"'))
assert.ok(html.includes('name="twitter:image" content="https://catalogue.fibro.test/fibro-catalogue-share-v2.jpg"'))
const image = readFileSync('public/fibro-catalogue-share-v2.jpg')
const metadata = await sharp(image).metadata()
assert.ok(readFileSync('test-results/share-build/fibro-catalogue-share-v2.jpg').equals(image))
